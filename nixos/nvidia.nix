...
in {
  ...
  boot.kernelParams = [
    ...
    # Performance/power optimizations - Adjusted for Battery/AC balance
    "nvidia.NVreg_RegistryDwords=PowerMizerEnable=0x1;PerfLevelSrc=0x2222;PowerMizerLevel=0x3;PowerMizerDefault=0x3;PowerMizerDefaultAC=0x1"
  ];
  ...
  hardware = {
    nvidia = {
      ...
      prime = {
        ...
        sync.enable = false;
        # PCI IDs verified for your hardware (Intel + Nvidia)
        intelBusId = "PCI:0:2:0"; # Integrated Intel GPU (Fixed from AMD)
  ...
  environment.systemPackages = with pkgs; [
    ...
    brightnessctl # Required for udev brightness rules
  ];
}
